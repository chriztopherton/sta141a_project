...
svmfm.res<-cbind(sum(diag(svm.tn.cm))/sum(svm.tn.cm),#accuracy
...
colnames(ln.res)<-c('Accuracy','Sensitivity','Specificity');res.sv3
```
...
```{r}
svm.mats<-list(svm.cm,svm.cm2,svm.cm4,svm.cm3)
