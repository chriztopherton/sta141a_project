...
**Question 3:**
*Is there a relationship between blood pressure and pregnancy?*
...
## needs written explination or state its answered with question 5
...
Both predictors, age and npreg, two of the most correlated variables, may not be necessary for determining diabetes. In descending order of AIC values, 441.71,423.65, and 422.87, we see the (type~ npreg) performs worst compared (type~age) which is best. In the model that considers both predictors, npreg is deemed insignicant.
